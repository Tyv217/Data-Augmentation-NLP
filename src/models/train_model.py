...
from ..data import IWSLT17DataModule, AGNewsDataModule, ColaDataModule, MNLIDataModule, TwitterDataModule, BabeDataModule, IMDBDataModule, TrecDataModule, DBPediaDataModule, FewShotTextClassifyWrapperModule, WikiText2DataModule
...
def text_classify(args):
    ...
    data_modules = {"cola": ColaDataModule, "mnli": MNLIDataModule, "twitter": TwitterDataModule, "babe": BabeDataModule, "ag_news": AGNewsDataModule, "imdb": IMDBDataModule, "trec": TrecDataModule, "dbpedia": DBPediaDataModule}
